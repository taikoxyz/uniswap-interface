...
const CHAIN_SUBGRAPH_URL: Record<number, string> = {
  ...
  [TAIKO_MAINNET_CHAIN_ID]: process.env.REACT_APP_TAIKO_MAINNET_SUBGRAPH_POOLS || 'https://api.goldsky.com/api/public/project_clz85cxrvng3n01ughcv5e7hg/subgraphs/uniswap-v3-taiko/136dd59/gn',
...
export const chainToApolloClient: Record<number, ApolloClient<NormalizedCacheObject>> = {
  ...
  [TAIKO_MAINNET_CHAIN_ID]: new ApolloClient({
    cache: new InMemoryCache(),
    link: new HttpLink({ uri: CHAIN_SUBGRAPH_URL[TAIKO_MAINNET_CHAIN_ID] }),
  }),

...
const TAIKO_JOLNIR_LIST = 'https://raw.githubusercontent.com/taikoxyz/uniswap-interface/taiko-uniswap-v3/src/constants/tokenLists/taiko.tokenlist.json'
...
export const DEFAULT_ACTIVE_LIST_URLS: string[] = [TAIKO_JOLNIR_LIST]

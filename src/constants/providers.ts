...
class AppJsonRpcProvider extends StaticJsonRpcProvider {
  ...
  constructor(chainId: SupportedInterfaceChain) {
    ...
    // Only Taiko chains are present in RPC_URLS; this class is only instantiated with Taiko ids below.
    super(RPC_URLS[chainId as keyof typeof RPC_URLS][0], /* networkish= */ { chainId, name: CHAIN_IDS_TO_NAMES[chainId] })
